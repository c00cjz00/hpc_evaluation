...
# 定義所有要處理的 JSON 檔案
file_paths = {
    "MedQA-USMLE": "output/answer_MedQA_USLME_test.json",
    "MedMCQA": "output/answer_MedMCQA_validation.json",
    "PubMedQA": "output/answer_PubMedQA_test.json",
    "MMLU-Pro-Medical": "output/answer_MMLU-Pro_Medical_test.json",
    "GPQA-Medical": "output/answer_GPQA_Medical_test.json",
}
